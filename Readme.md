...
That's why we are hiring you. This is a code that will create a table dynamically based upon a [dataset provided](Data/data.js). We also need to allow our users to search through the table for specific pieces of information. There's a catch though... We only use pure JavaScript, HTML, and CSS on our web pages. They are the only coding languages which can be trusted.
...
* Using the ufo dataset provided in the form of a JavaScript object, code that appends a table to your web page and then adds new rows of data for each UFO sighting.
